// Diagnostic: draw on signature, check what gets saved.
...
if (keys.length > 0) {
  ...
  console.log('draft fields[tspSignatureDataUrl]:', draft.fields?.tspSignatureDataUrl?.substring(0, 50));
}
